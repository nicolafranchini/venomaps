...
👉 [Try the online demo and see it in action!](https://veno.es/venomaps/)
...
= 2.1.8 =
* Fix: attribution links broken by missing quote

= 2.1.7 =
* Update: tested up to WordPress 7.1

= 2.1.6 =
* New Option: Disable Clusters
* Update: Italian and Spanish language update

= 2.1.5 =
* Fix: Admin footer text accidentally hidden

= 2.1.4 =
* Update: tested up to WordPress 7.0

= 2.1.3 =
* Update: Allow CSV import with partial fields
* Update: UI / UX improvements

= 2.1.2 =
* New: Custom Default Marker style
* New: Block option "Auto-fit Map" to show all markers
* Update: Code reorganization

= 2.1.1 =
* Internal dependency security updates.
...
= 2.0.9 =
* Update: Cluster click over Route

= 2.0.8 =
* Update: Hidden route info panel if title field is empty
